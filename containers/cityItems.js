...
import { CityItems, CityList, Masthead } from '../components';
...
function cityItemsContainer({destinations}) {
  ...
  return (
    ...
    <Masthead>
      <Masthead.Wrapper>
        <Masthead.Title>Where are you going?</Masthead.Title>
        <Masthead.Logo>
    ...
    {destinations && destinations.map(destination => (
      ...
      <CityItems.Logo>
        ...
        <path d="M22.6667 17.0526V5.68421L17 0L11.3333 5.68421V9.47368H0V36H34V17.0526H22.6667ZM7.55556 32.2105H3.77778V28.4211H7.55556V32.2105ZM7.55556 24.6316H3.77778V20.8421H7.55556V24.6316ZM7.55556 17.0526H3.77778V13.2632H7.55556V17.0526ZM18.8889 32.2105H15.1111V28.4211H18.8889V32.2105ZM18.8889 24.6316H15.1111V20.8421H18.8889V24.6316ZM18.8889 17.0526H15.1111V13.2632H18.8889V17.0526ZM18.8889 9.47368H15.1111V5.68421H18.8889V9.47368ZM30.2222 32.2105H26.4444V28.4211H30.2222V32.2105ZM30.2222 24.6316H26.4444V20.8421H30.2222V24.6316Z" fill="#FF8906"/>
        </svg>
      </CityItems.Logo>
      </Link>
      </CityItems>
